...
/**
 * The purpose of this class is to ease the creation of markdown documents It
 * provides certain static methods which can be called to format a string as a
 * markdown which will then be rendered as such.
 * 
 * @author cschindler
 *
 */
